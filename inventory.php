...
<body>
  <header>
    ...
    <div class="header-nav" id="headerNav">
      <button class="btn" onclick="location.href='owner.php'"><i class="fas fa-door-open"></i> <span>Rooms</span></button>
...
<script>
  function logoutNow(el) {
    ...
    if (navigator.sendBeacon) {
      // send lightweight background logout then redirect immediately
