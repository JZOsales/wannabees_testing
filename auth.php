...
// Check if user must change password (OTP setup pending)
if ($user['must_change_password'] == 1) {
    header('Location: index.php?error=Please complete first-time setup. Use "First Time Login" tab.');
    exit;
}
...
if ($role === 1) {
    ...
    header('Location: room_tablet.php');
} else {
