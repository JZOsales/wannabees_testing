...
if (isset($_SESSION['user_id'])) {
    ...
    if ($role === 1) header('Location: owner.php');
    else if ($role === 2) header('Location: staff.php');
    else if ($role === 3) header('Location: cashier.php');
    else if ($role === 4) header('Location: room_tablet.php');
