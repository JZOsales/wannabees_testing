...
<body>
  <header>
    ...
    <div class="header-nav" id="headerNav">
      <button class="btn" onclick="location.href='owner.php'">
  ...
  <main>
    ...
    <div class="roles-grid">
      ...
      <div class="role-card">
        ...
        <p class="role-description">Room maintenance and status management</p>
        <ul class="role-features">
          <li><i class="fas fa-check-circle"></i> View room status</li>
          <li><i class="fas fa-check-circle"></i> Mark rooms as cleaning</li>
          <li><i class="fas fa-check-circle"></i> Mark rooms as available</li>
          <li><i class="fas fa-check-circle"></i> Log cleaning activities</li>
          <li><i class="fas fa-check-circle"></i> Manage order</li>
        </ul>
      </div>
      ...
      <div class="role-card">
        ...
        <p class="role-description">Payment processing and billing</p>
        <ul class="role-features">
          <li><i class="fas fa-check-circle"></i> Process payments</li>
          <li><i class="fas fa-check-circle"></i> View bills</li>
          <li><i class="fas fa-check-circle"></i> Handle transactions</li>
          <li><i class="fas fa-check-circle"></i> Generate receipts</li>
        </ul>
      </div>
      ...
      <div class="role-card">
        ...
        <ul class="role-features">
          ...
          <li><i class="fas fa-check-circle"></i> See remaining time</li>
        </ul>
      </div>
    </div>
      ...
      <div class="workflow-steps">
        ...
        <div class="workflow-step">
          ...
          <div class="step-content">
            ...
            <p class="step-description">Staff prepares room for next customer</p>
            <div class="step-details">
              <ul>
                <li>Staff enters room for cleaning</li>
                <li>Cleans and tidies the room</li>
                <li>Restocks amenities if needed</li>
                <li>Checks equipment functionality</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="workflow-step">
          ...
          <div class="step-content">
            ...
            <p class="step-description">Staff marks room ready for next customer</p>
            <div class="step-details">
              <ul>
                <li>Staff logs in to system</li>
                <li>Clicks cleaning room</li>
